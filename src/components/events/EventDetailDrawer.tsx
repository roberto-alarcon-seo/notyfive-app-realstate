...
export function EventDetailDrawer({ event, open, onOpenChange, onEdit }: EventDetailDrawerProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side={isMobile ? "bottom" : "right"} className={isMobile ? "h-[90vh] rounded-t-2xl p-0 flex flex-col max-w-[100vw] overflow-x-hidden" : "w-full sm:max-w-lg p-0 flex flex-col overflow-hidden"}>
        {/* Header */}

...
function applyCssVariables(partner: PartnerBranding) {
  ...
  root.style.setProperty("--primary", partner.primaryColorHsl);
  root.style.setProperty("--ring", partner.primaryColorHsl);
  root.style.setProperty("--sidebar-primary", partner.primaryColorHsl);
  root.style.setProperty("--sidebar-ring", partner.primaryColorHsl);
  root.style.setProperty("--message-outgoing", partner.primaryColorHsl);
...
export function PartnerBrandingProvider({ children }: { children: ReactNode }) {
  ...
  // Apply CSS vars on mount + whenever partner changes
  useEffect(() => {
